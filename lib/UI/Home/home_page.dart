                ...
                children: [
                  ...
                  BlocBuilder(
                      ...
                      builder: (context, state) {
                        ...
                        return Row(
                          children: [
                            showDataWithIcons(state.pulse.toDouble(), 'BPM', 'Pulse', ImageConstants.pulseIcon, context),
                            showDataWithIcons(state.weight.toDouble(), 'Kg', 'Weight', ImageConstants.weight, context),
                          ],
                        );
                      }
                  ),
          ...
          BlocBuilder(
              ...
              builder: (context, state) {
                ...
                return BlurredScreen(
                    displayBlurredScreen:
                    state.showBlurredVision
                );
              }
          ),
