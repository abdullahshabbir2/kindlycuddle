...
import 'package:cuddle_care/UI/User%20Guide/User%20Guide%201/user_guide1_page.dart';
...
class UserGuide1Navigator with UserGuide1Route,UserGuide2Route{
...
mixin UserGuide1Route{
  openUserGuide1Page(UserGuide1InitialParams initialParams)
  {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => UserGuide1Page(cubit: getIt(param1: initialParams),))
    );
  }
