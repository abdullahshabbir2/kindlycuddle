...
//         body: CustomPaint(
//           size: Size(
//               MediaQuery.of(context).size.width * (80 / 375),
//               MediaQuery.of(context).size.width *
//                   (80 / 812)), // Size of the canvas
//           painter: PieChartPainter(green: 45, lightGreen: 55, light: null, main: null),
//         ),
//       ),
//     );
//   }
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: PieChartPainter(
          green: mainColor, lightGreen: lightColor, light: light, main: main),
    );
  }
}
...
class PieChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final rectLarger = Rect.fromCenter(
      center: Offset(size.width / 2, size.height / 2),
      width:
          size.width * 1.1, // Slightly larger size for the dark green section
    ...
    final lightGreenSweepAngle =
        2 * pi * (lightGreen / 100); // 25% of the circle (90 degrees)
    ...
    final darkGreenSweepAngle =
        2 * pi * (green / 100); // 75% of the circle (270 degrees)
    canvas.drawArc(rectLarger, lightGreenSweepAngle, darkGreenSweepAngle, true,
        darkGreenPaint);
  }
